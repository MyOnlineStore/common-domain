...
final class CurrencyIso
{
    ...
    public static function fromString(string $code): self
    {
        if (!isset(self::CURRENCIES[$code])) {
            throw new InvalidCurrencyIso(\sprintf('Given value "%s" is not a valid ISO 4217 code', $code));
        }

        return new self(self::CURRENCIES[$code]['alphabeticCode']);
    }
    ...
    {
        return self::CURRENCIES[$this->currency]['minorUnit'];
    }
